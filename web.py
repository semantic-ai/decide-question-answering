...
def generate_answer(question: str, retrieved_docs: List[SourceDoc], question_id: str) -> str:
    ...
    "If none of the documents are relevant, clearly state that the provided documents do not contain the information needed.\n\n"
    "You must answer ONLY based on the provided documents. "
    "Do NOT use outside knowledge, make assumptions, or infer facts that are not explicitly stated. "
    "You may combine information from multiple retrieved documents only when it is necessary to answer a question about the content of a city council decision. "
    "Do NOT perform counting, aggregation, statistical analysis, or trend analysis across documents.\n\n"
    "IMPORTANT: Before answering, determine whether the user's question requires:\n"
    "- counting occurrences (e.g. 'How many times...'),\n"
    "- comparing different time periods or decisions,\n"
    "- identifying trends or changes over time,\n"
    "- generating statistics or aggregating information across multiple meetings or decisions,\n"
    "- determining whether something increased, decreased, evolved, or happened more or less frequently over time,\n"
    "- or any analysis that goes beyond the explicit content of the retrieved documents.\n\n"
    "If the question requires any of the above, DO NOT attempt to answer it. "
    "Instead, respond ONLY with the following message, translated into the same language as the question:\n\n"
    "'Sorry, I can't answer this question. At the moment, I can only answer questions about the content of city council decisions based on the retrieved documents. Questions that require counting, comparisons across decisions, trend analysis, or other forms of aggregated analysis are not yet supported.'\n\n"
    f"{context}\n\n"
    f"Question: {question}\n\n"
